-- =====================================================
-- MOGIANA (empresa3) — BANCO DE DADOS COMPLETO
-- =====================================================
-- Schema consolidado do Nexus Gestão Financeira.
-- Empréstimos: apenas 30 dias e 20 dias (prazo no app).
--
-- Projeto Supabase: otawgdmokeavpmngjtac
...
SELECT
    'MOGIANA DATABASE SETUP COMPLETED' AS status,
    'Schema completo — empréstimos 30 e 20 dias no app' AS message,
